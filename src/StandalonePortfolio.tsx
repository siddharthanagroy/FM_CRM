...
import { Plus, CreditCard as Edit2, Trash2, Search, Building2, AlertTriangle, X } from 'lucide-react';
...
export default function StandalonePortfolio() {
  ...
  useEffect(() => {
    if (editingPortfolio) {
      setFormData({
        portfolioid: editingPortfolio.portfolioid,
        name: editingPortfolio.name,
        description: editingPortfolio.description || '',
        organizationid: editingPortfolio.organizationid,
      });
    } else {
      setFormData({
        portfolioid: '',
          ...
          <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              ...
              <div className="flex gap-3 pt-4 border-t border-slate-200">
                ...
                >
                  {saving ? 'Saving...' : editingPortfolio ? 'Update Portfolio' : 'Create Portfolio'}
                </button>
              </div>
            </form>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-2xl max-w-md w-full">
            <div className="p-6">
              ...
              <p className="text-slate-600 mb-2">
                Are you sure you want to delete the portfolio <strong>{deletingPortfolio.name}</strong>?
              </p>
              ...
              <div className="bg-slate-50 border border-slate-200 rounded-lg p-3 mb-4">
                <div className="text-sm space-y-1">
                  <div className="flex justify-between">
                    ...
                    <span className="font-mono text-slate-900">{deletingPortfolio.portfolioid}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-600">Organization:</span>
                    <span className="text-slate-900">{deletingPortfolio.organization_name}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <button
                  onClick={() => handleDelete(deletingPortfolio)}
